package ru.netcraker.main_controller;

import ru.netcraker.service.ApplicationService;

import java.util.List;
import java.util.Scanner;
import java.util.StringJoiner;

import static ru.netcraker.utility.Utility.COMMA_SEPARATED_DELIMITER;
...
public class ApplicationController {
    ...
    public void takeUserInput() {
        System.out.println("\nPlease enter your chess piece and it's current position separated by a space. For example: King D5");
